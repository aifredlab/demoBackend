...
//	@PostMapping(value = "/askContents")
	public ResponseEntity<String> testAskContents(@RequestBody  QuestionRequest questionRequest) {
...
//	@PostMapping(value = "/ask", produces = MediaType.APPLICATION_NDJSON_VALUE)
	public Flux<String> testStreamDataPush(@RequestBody  QuestionRequest questionRequest) {
